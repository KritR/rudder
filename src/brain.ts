...
export function renderContract(spec: SpecContract): string {
  const instructions = spec.instructionsFiles
    ...
    .join("\n\n");
  return [
    "RUDDER PROMPT INJECTION CONTRACT",
    "This block was generated and injected by Rudder. It is coordination context, not text typed by the user.",
    "",
    `Task: ${spec.task}`,
    "",
    "Acceptance criteria:",
    ...
    "END RUDDER PROMPT INJECTION CONTRACT",
  ]
    .filter(Boolean)
    .join("\n");
}
